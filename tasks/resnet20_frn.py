...
class BlockV1(hk.Module):
    ...
    def __init__(
        ...
        conv_0 = hk.Conv2D(
            ...
            padding="SAME",
            name="conv_0")
        bn_0 = FeatureResponseNorm(name='frn_1') #  
        ...
        bn_1 =  FeatureResponseNorm(name='frn_2') # 
    ...
    def __call__(self, inputs, is_training, test_local_stats):
        ...
        return jax.nn.silu(out + shortcut)
...
class ResNet(hk.Module):
    ...
    def __init__(
        ...
        self.initial_conv = hk.Conv2D(
            ...
            padding="SAME",
            name="initial_conv")
        self.initial_batchnorm = FeatureResponseNorm(name='frn_init') # 
